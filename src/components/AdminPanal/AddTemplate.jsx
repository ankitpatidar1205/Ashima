...
import { addTemplate } from "../../Redux/slices/templateSlice/templateSlice";
...
const AddTemplateModal = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async () => {
    ...
    navigate("/CertificateTemplate"); // Redirect after successful submit
  };

  const handleCancel = () => {
    navigate("/CertificateTemplate"); // Redirect on cancel
  };
